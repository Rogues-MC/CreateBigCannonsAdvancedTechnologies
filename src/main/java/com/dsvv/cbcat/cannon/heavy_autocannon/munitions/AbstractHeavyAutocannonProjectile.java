...
public abstract class AbstractHeavyAutocannonProjectile extends AbstractCannonProjectile
{
    ...
    public HeavyAutocannonAmmoType getAutocannonRoundType() { return HeavyAutocannonAmmoType.NORMAL; }
}
